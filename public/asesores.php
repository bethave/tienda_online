...
<head>
    ...
    <title>Tienda Online - Asesores</title>
...
<body>
    ...
    <!-- Contenido de la página de asesores -->
    <div class="container-custom">
    <h1 class="section-title">Nuestros Asesores</h1>
    <div class="d-flex flex-wrap justify-content-center">
        <div class="advisor-card">
            <img src="asesores/juan.jfif" alt="Juan Pérez">
            <h3>Juan Pérez</h3>
            <p><I>VENDEDOR ONLINE</I> <br>Responsable de gestionar las ventas a través de plataformas digitales, brindando atención personalizada a los clientes. <br><I>HABILIDADES</I> <br>Comunicación efectiva, manejo de redes sociales, conocimiento en comercio electrónico.</p>
        </div>
        <div class="advisor-card">
            <img src="asesores/maria.avif" alt="María González">
            <h3>María González</h3>
            <p><I>VENDEDORA ONLINE</I> <br> Impulsa las ventas online mediante una atención rápida y profesional. Está encargada de responder mensajes, gestionar pedidos y realizar seguimiento a los clientes para garantizar su fidelización. <br><I>HABILIDADES</I> <br>Atención al cliente, gestión de plataformas digitales, persuasión.</p>
        </div>
        <div class="advisor-card">
            <img src="asesores/luis.jpg" alt="Luis Fernández">
            <h3>Luis Fernández</h3>
            <p><I>VENDEDOR ONLINE</I> <br>Administra las ventas a través de diversas plataformas online, aplicando estrategias SEO y marketing para aumentar la visibilidad de los productos. <br><I>HABILIDADES</I> <br>Marketing digital, análisis de datos, negociación.</p>
        </div>
        <div class="advisor-card">
            <img src="asesores/maria.jpg" alt="Laura Martínez">
            <h3>Laura Martínez</h3>
            <p><I>VENDEDORA ONLINE</I> <br>Gestiona la comunicación con los clientes a través de redes sociales y plataformas de ventas en línea.  <br><I>HABILIDADES</I> <br> Creatividad, manejo de redes sociales, ventas y promociones.</p>
        </div>
    </div>
</div>
