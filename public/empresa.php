...
<head>
    ...
    <title>Tienda Online - Empresa</title>
...
<body>
    ...
    <!-- Contenido de la página de la empresa -->
    <div class="container-custom">
        <div class="section-content">
            <h1 class="section-title">LA EMPRESA</h1>
            <hr class="gradient-hr">
            <p><strong>Empresa</strong></p>
            <p>Somos una tienda online dedicada a la venta de herramientas y equipos industriales de alta calidad, ofreciendo productos de marcas reconocidas como BOSH, MAKITA, TRAMONTINA, y FASCY, entre otras. Estamos disponibles las 24 horas del día, todos los días de la semana para brindarte la mejor atención.</p>
            <p>Contamos con un equipo de profesionales altamente capacitados que están listos para asesorarte en la elección de los productos que mejor se adapten a tus necesidades.</p>
            <p><strong>Misión</strong></p>
            <p>Nuestra misión es ofrecer herramientas y equipos de la más alta calidad para satisfacer las necesidades de nuestros clientes, contribuyendo a sus proyectos con productos duraderos y eficientes.</p>
            <p><strong>Visión</strong></p>
            <p>Ser la tienda online líder en la venta de herramientas y equipos industriales, reconocida por la calidad de nuestros productos y el excelente servicio al cliente.</p>
        </div>
        <div class="logo">
            <img src="logos/icono.webp" alt="Logo de la Empresa">
        </div>
    </div>
